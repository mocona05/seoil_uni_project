...
#define READ_BUILTIN_LED_PIN    digitalRead(LED_BUILTIN_PIN)
#define READ_RED_LED_PIN        digitalRead(LED_RED_PIN)
#define READ_GREEN_LED_PIN      digitalRead(LED_GREEN_PIN)
#define READ_BLUE_LED_PIN       digitalRead(LED_BLUE_PIN)